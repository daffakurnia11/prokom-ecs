...
@section('container')
  ...
  <h6 class="mb-0 text-uppercase">Form Pembuatan Jadwal Pelatihan Prokom 2022</h6>
    <hr>
    <div class="card col-lg-9 col-xxl-6">
      <form action="/admin/jadwal" method="post" enctype="multipart/form-data">
          ...
          <div class="row">
            <div class="col-sm-4">
              <div class="mb-3">
                ...
                <input class="result form-control @error('date') is-invalid @enderror" value="{{ old('date') }}" type="text" name="date" id="dateStart">
                @error('date')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
            ...
            <div class="col-sm-4">
              <div class="mb-3">
                ...
                <input class="result form-control @error('time_start') is-invalid @enderror" value="{{ old('time_start') }}" type="text" name="time_start" id="timeStart">
                @error('time_start')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
            ...
            <div class="col-sm-4">
              <div class="mb-3">
                ...
                <input class="result form-control @error('time_ended') is-invalid @enderror" value="{{ old('time_ended') }}" type="text" name="time_ended" id="timeEnded">
                @error('time_ended')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
        ...
        <div class="card-footer">
          <button type="submit" class="btn btn-success">Buat Jadwal Baru!</button>
        </div>
      </form>
    </div> 
